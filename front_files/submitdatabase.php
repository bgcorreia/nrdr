...
<h3>Send your information for NRDR if you want to suggest any database, please fill the form below</h3>
<br>
...
<div class="row">
    ...
    <div class="col-md-6 form-group">
        <label for="phone">Contact phone number (including country code) </label>
...
<div class="row">
    ...
    <div class="col-md-4 form-group">
        ...
        <select id="rnatype" name="rnatype" class="form-control">
            ...
            <option value="TERC">Others</option>
        </select>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            <p class="help-block">The file should contain only the organism's name, <a
                    href="files/example-organism-file.txt" target="_blank">example</a>.</p>
        </div>
    </div>
</div>
...
<div class="panel-footer" style="text-align: right">
    ...
    <button type="submit" class="btn btn-primary" style="margin-right: 10px;" id="btnSubmitForm">
    ...
    $(function () {
        ...
        $(document).on("click", "#btnSubmitForm", function () {
            ...
            if ($("#sname").val() == "") {
                ...
                $('#divDanger').children('div').html("Fill all the required fields");
                error = true;
            }else{
            ...
            if ($("#dbname").val() == "") {
                ...
                $("#dbname").parent().removeClass("has-error");
            }
        ...
        $('#btnAddTerm').click(function () {
            ...
            var stringTermHidden = "<input type='hidden' id='termo-" + idTermo + "' name='informationContent[]' value=\"" + termo + "\">";
